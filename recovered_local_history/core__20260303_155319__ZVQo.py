...
def _apply_global_qt_styles(app: QApplication) -> None:
    ...
    try:
        ...
        toolbar_button_h = 24
        app.setStyleSheet(
            f"QPushButton {{ min-height: {button_h}px; max-height: {button_h}px; padding: 0px 8px; }}\n"
            f"QToolBar QPushButton {{ min-height: {toolbar_button_h}px; max-height: {toolbar_button_h}px; padding: 0px 8px; }}\n"
